...
> **Состояние на 2026-08-21:** реализация прошла RED–GREEN, полный набор
> проверок на current stable и Dart 3.6, а также независимое ревью; коммит и
> publish dry-run впереди.
