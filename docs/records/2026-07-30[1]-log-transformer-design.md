> **Состояние на 2026-08-17:** сделано и смержено (`2488163`, `e3086b7`),
> вышло в 0.5.2 как `Logger.transformer` + `Log.copyWith`; разграничение с
> `Loggable.sanitizer` уточнено в `c0b2526`.
> **Что это:** дизайн-спека хука обработки лога до публикации.
> **Связанные записи:** `2026-07-30[2]-log-transformer-plan.md`,
> `2026-07-30[3]-data-sanitizer-design.md`.
