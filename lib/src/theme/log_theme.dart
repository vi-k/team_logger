...
final class LogTheme with Loggable {
  ...
  static const LogTheme defaultActiveTheme = LogTheme._(
    verbose: LogLevelTheme._(
      ...
      emphasisStyle: _activeVerboseEmphasisStyle,
      ...
      sectionStyle: _activeVerboseBoldStyle,
      ...
      stackTraceActiveMemberStyle: _activeVerboseEmphasisStyle,
      stackTraceActiveStyle: ansi.NoStyle(),
      stackTraceInactiveMemberStyle: _activeVerboseDimStyle,
      stackTraceInactiveStyle: _activeVerboseDimStyle,
    ),
    debug: LogLevelTheme._(
      normalStyle: _activeDebugNormalStyle,
      boldStyle: _activeDebugBoldStyle,
      emphasisStyle: _activeDebugEmphasisStyle,
      ...
      sectionStyle: _activeDebugBoldStyle,
      dataNameStyle: ansi.NoStyle(),
      ...
      stackTraceActiveMemberStyle: _activeDebugEmphasisStyle,
      stackTraceActiveStyle: ansi.NoStyle(),
      stackTraceInactiveMemberStyle: _activeDebugDimStyle,
      stackTraceInactiveStyle: _activeDebugDimStyle,
    ),
    info: LogLevelTheme._(
      normalStyle: _activeInfoNormalStyle,
      boldStyle: _activeInfoBoldStyle,
      emphasisStyle: _activeInfoEmphasisStyle,
      ...
      sectionStyle: _activeInfoBoldStyle,
      dataNameStyle: ansi.NoStyle(),
      ...
      stackTraceActiveMemberStyle: _activeInfoEmphasisStyle,
      stackTraceActiveStyle: ansi.NoStyle(),
      stackTraceInactiveMemberStyle: _activeInfoDimStyle,
      stackTraceInactiveStyle: _activeInfoDimStyle,
    ),
    warning: LogLevelTheme._(
      normalStyle: _activeWarningNormalStyle,
      boldStyle: _activeWarningBoldStyle,
      emphasisStyle: _activeWarningEmphasisStyle,
      ...
      sectionStyle: _activeWarningBoldStyle,
      dataNameStyle: ansi.NoStyle(),
      ...
      stackTraceActiveMemberStyle: _activeWarningEmphasisStyle,
      stackTraceActiveStyle: ansi.NoStyle(),
      stackTraceInactiveMemberStyle: _activeWarningDimStyle,
      stackTraceInactiveStyle: _activeWarningDimStyle,
    ),
    error: LogLevelTheme._(
      normalStyle: _activeErrorNormalStyle,
      boldStyle: _activeErrorBoldStyle,
      emphasisStyle: _activeErrorEmphasisStyle,
      ...
      sectionStyle: _activeErrorBoldStyle,
      dataNameStyle: ansi.NoStyle(),
      ...
      stackTraceActiveMemberStyle: _activeErrorEmphasisStyle,
      stackTraceActiveStyle: ansi.NoStyle(),
      stackTraceInactiveMemberStyle: _activeErrorDimStyle,
      stackTraceInactiveStyle: _activeErrorDimStyle,
    ),
    critical: LogLevelTheme._(
      normalStyle: _activeCriticalNormalStyle,
      boldStyle: _activeCriticalBoldStyle,
      emphasisStyle: _activeCriticalEmphasisStyle,
      ...
      sectionStyle: _activeCriticalBoldStyle,
      dataNameStyle: ansi.NoStyle(),
      ...
      stackTraceActiveMemberStyle: _activeCriticalEmphasisStyle,
      stackTraceActiveStyle: ansi.NoStyle(),
      stackTraceInactiveMemberStyle: _activeCriticalDimStyle,
      stackTraceInactiveStyle: _activeCriticalDimStyle,
    ),
