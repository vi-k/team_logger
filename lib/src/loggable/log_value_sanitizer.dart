...
final class SanitizeContext {
  ...
  /// конвертером, и сам объект `view` в
  /// [Loggable.objectToString]/[Loggable.objectToJson] не уходит (см.
  /// спеку, раздел «Правило view»). Если конвертер зовёт обходчики сам —
  /// зовёт он их уже для своих внутренних значений, и те предлагаются
  /// правилу под путём этого свойства. Слепое пятно, о котором надо
  /// знать: правило по содержимому
  ///
  /// ```dart
