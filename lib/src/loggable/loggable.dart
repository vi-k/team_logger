...
abstract mixin class Loggable {
  ...
  /// `error` и теги библиотека рендерит через
  /// [renderOutsideSanitizerScope]. Замаскировать эти поля или отбросить
  /// лог целиком — задача `Logger.transformer`.
  ///
  ...
  /// принтере и в `FileLogCodec`, каждый тег в `LazyTags.convert`.
